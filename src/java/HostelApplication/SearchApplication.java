...
public class SearchApplication extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Application applications = applicationService.findApplicationByIc(ic);
            HttpSession session = request.getSession();
            session.setAttribute("application", applications);
            response.sendRedirect("HostelApplication/SearchResult.jsp");
        } catch (Exception ex) {
