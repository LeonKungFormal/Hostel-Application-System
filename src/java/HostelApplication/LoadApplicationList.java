 ...
 * @author Lion
 */
public class LoadApplicationList extends HttpServlet {
...
try {
    ...
    for(int i = 0;i<applicationsList.size();i++){
        ...
        Counter++;    
              ...
              response.sendRedirect("HostelApplication/DisplayApplicationList.jsp");
          } catch (Exception ex) {
              Logger.getLogger(LoadApplicationList.class.getName()).log(Level.SEVERE, null, ex);
          }
      }
