...
public class ProcessResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (button.equals("DeleteApplication")) {
                response.sendRedirect("HostelApplication/DeleteApplication.jsp");
            } else {
                response.sendRedirect("HostelApplication/UpdateApplication.jsp");
            }
